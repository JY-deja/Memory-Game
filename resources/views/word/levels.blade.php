...
<head>
    ...
    <link rel="stylesheet" href="css/levelStyle.css">
    <script src="js/scriptLevel.js" defer></script>
</head>
<body>
    <div>
        <h1 class="m-6 text-center bold p-4 fw-bold text-gradient">Select Level</h1>
    </div>
